...
SECRET_KEY = 'django-insecure-y7o7i@pza5#$dng(t@x2%jr8u-6^r^!4q_3v)4ws!q2ghhwmw@'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'helloworld_project.context_processors.cart_item_count', # Custom context processor
            ],
        },
    },
]
